...
- Foco em tendências de consumo:
  ...
  - Versões zero açúcar.
  - Apenas lata 350ml (redução de plástico e foco em consumo individual).
- Identidade visual moderna, com frutas e benefícios destacados.
- Qualidade associada ao Grupo Heineken.

## Portfólio
### Regulares (50% menos açúcar)
- Guaraná da Amazônia
- Limão Siciliano
- Laranja-Pera
...
### Tônica
- Tônica com toque de limão siciliano (regular e zero)
...
- Mensagem central: “Não ser o número 1 pode render boas risadas.”
- Público-alvo: jovens adultos vivendo pressão do dia a dia.
- A marca abraça o fato de não ser líder e transforma isso em personalidade.

### Exemplos de campanhas
- Kerline (BBB) brincando com “não ser número 1”.
- Luana Zuccolotto (humor CLT).
- Conteúdos que exploram situações reais com humor.
...
Padarias vendem pouco álcool → recebem pouca atenção.

## Desafio proposto aos alunos
Criar uma solução de IA que:
1. Identifique padarias com potencial.
